...
class AttendancesModel {
    saveAttendances(connection, data) {
    ...
    saveImportedLog(connection, imported_at, start, end, total) {
        return new Promise((resolve, reject) => {
            let sql = `
    ...
    removeAttendances(connection, start, end) {
        return new Promise((resolve, reject) => {
    ...
    removeOldProcess(connection, start, end) {
        return new Promise((resolve, reject) => {
    ...
    getInitialEmployees(connection, start, end) {
        return new Promise((resolve, reject) => {
            let sql = `
    ...
    saveProcessLog(connection, processAt, start, end, total) {
        return new Promise((resolve, reject) => {
            let sql = `
    ...
    saveInitialLog(connection, initialAt, year, month) {
        return new Promise((resolve, reject) => {
            let sql = `
    ...
    getEmployeeDetail(connection, employeeCode) {
        return new Promise((resolve, reject) => {
            let sql = `
    ...
    getEmployeeWorkDetail(connection, employeeCode, start, end) {
        return new Promise((resolve, reject) => {
            let sql = `
      select t.work_date,
      (
    ...
    processSummary(connection, start, end) {
    ...
    doProcess(connection, start, end) {
        return new Promise((resolve, reject) => {
            let sql = `
...
exports.AttendancesModel = AttendancesModel;
